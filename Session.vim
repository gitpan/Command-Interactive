...
silent only
cd /apps/Command-Interactive
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +5 t/interactive_use.t
badd +0 lib/Command/Interactive.pm
badd +150 lib/Command/Interactive/Interaction.pm
badd +0 t/basic.t
badd +0 t/interaction.t
badd +0 t/password.t
badd +0 t/pathological.t
badd +0 t/regex.t
badd +0 t/system_only.t
badd +0 t/001.t
badd +0 dist.ini
args t/interactive_use.t
edit lib/Command/Interactive/Interaction.pm
...
exe '7resize ' . ((&lines * 1 + 34) / 68)
exe 'vert 7resize ' . ((&columns * 104 + 119) / 239)
exe '8resize ' . ((&lines * 1 + 34) / 68)
exe 'vert 8resize ' . ((&columns * 104 + 119) / 239)
exe '9resize ' . ((&lines * 1 + 34) / 68)
exe 'vert 9resize ' . ((&columns * 104 + 119) / 239)
exe '10resize ' . ((&lines * 54 + 34) / 68)
exe 'vert 10resize ' . ((&columns * 104 + 119) / 239)
exe '11resize ' . ((&lines * 1 + 34) / 68)
exe 'vert 11resize ' . ((&columns * 104 + 119) / 239)
argglobal
enew
file __Tag_List__
let s:cpo_save=&cpo
...
13
normal! 014l
lcd /apps/Command-Interactive
wincmd w
argglobal
edit /apps/Command-Interactive/dist.ini
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit /apps/Command-Interactive/lib/Command/Interactive.pm
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit /apps/Command-Interactive/t/system_only.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit /apps/Command-Interactive/t/regex.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit /apps/Command-Interactive/t/pathological.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit /apps/Command-Interactive/t/password.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit /apps/Command-Interactive/t/interaction.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit /apps/Command-Interactive/t/001.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit /apps/Command-Interactive/t/basic.t
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
